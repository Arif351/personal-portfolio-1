        ...
        <div>
            <div className=''>
                ...
                {/* <video className='brightness-50' autoPlay loop muted>
                    <source src="https://www.pexels.com/video/starry-night-sky-timelapse-5818973/" type='video/mp4' />
                </video> */}
                {/* <video className='brightness-50' autoPlay loop muted>
                ...
                <div className='text-center'>
                    ...
                    <h4 className="typeWriter2 text-2xl text-white font-semibold text-center web"> A Full Stack Web Developer
                        {/* <Typewriter
                            options={{
                                strings: [''],
                                autoStart: true,
